...
# Configure Gemini AI
GOOGLE_API_KEY = os.environ.get("GOOGLE_API_KEY", "AIzaSyC-mMSX_CRu42U-ZhOtPdIfth4jKOSq-Ac")
...
@app.get("/")
def read_root():
    return {"message": "Welcome to MedTalkBuddy API - Vercel Deployment"}

@app.get("/api/v1/health")
def health_check():
    return {"status": "healthy", "model_loaded": True, "deployment": "vercel"}
...
#     import uvicorn
#     uvicorn.run("vercel_main:app", host="0.0.0.0", port=port, reload=True)
